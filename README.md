...
Two Markov generator augmented poem examples can be seen below. The first has equal weighting between the text samples and the second is weighted 40 to 1 in favor of my poem:
